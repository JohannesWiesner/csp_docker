...
# Timestamp: 2021/04/08 15:34:49 UTC
# 
...
RUN export TMPDIR="$(mktemp -d)" \
    ...
    && curl --insecure -o /tmp/spm12.zip https://www.fil.ion.ucl.ac.uk/spm/download/restricted/utopia/previous/spm12_r7771_R2010a.zip \
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "mkdir /home/neuro/workdir && chmod 777 /home/neuro/workdir && chmod a+s /home/neuro/workdir" \
    \n    ], \
    \n    [ \
    \n      "run", \
    \n      "chown -R neuro /home/neuro/workdir" \
    \n    ], \
    \n    [ \
    \n      "run", \
